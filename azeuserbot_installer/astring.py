...
import sys
import subprocess
from azeuserbot_installer import hata, bilgi, onemli, soru
...
def main():
    ...
    if Sonuc == "2":
        ...
        if soup.title.string == "Create new application":
            ...
            app_title = soru("Application adı nə olsun? (Aftomatik Oluşdurmag üçün Boşlug Buraxın): ")
            if app_title == '':
            ...
            if app == "ERROR":
                hata("(!) Telegram aftomatik açma işleminizi bloklandi. Lütfen scripti təzədən başlatın.")
                exit(1)
