...
def tamamlandi (saniye):
   console.print(Panel(f"[bold green]Qurlaşdırma Tamamlandı!\n[i]Botu {round(saniye)} saniye içinde qurdunuz.[/]\n\n[bold green]Bir neçe deqiqə sonra hər hansı bir sohbette .aze yazarak test edebilirsiniz. Keyf edin aqa[/]"), justify="center")                         
